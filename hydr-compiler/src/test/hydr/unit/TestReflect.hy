...
class TestReflect extends Test {
	...
	static var TYPES : Array<Dynamic> = [
		...
		Array,hydr.ds.StringMap,List,Date,Xml,Math,
	...
	static var TNAMES = [
		"null","Int","String","Bool","Float",
		"Array",u("hydr.ds.StringMap"),u("List"),"Date","Xml","Math",
	...
	public function testIs() {
		...
		is([],Array);
		is(new List(),List);
		is(new hydr.ds.StringMap(),hydr.ds.StringMap);
	...
	function is( v : Dynamic, t1 : Dynamic, ?t2 : Dynamic, ?pos : hydr.PosInfos ){
	...
	public function testTypeof() {
		...
		typeof(new hydr.ds.StringMap(),TClass(hydr.ds.StringMap));
	...
	function typeof( v : Dynamic, rt : ValueType, ?pos : hydr.PosInfos ) {
