#if !flash8
// normal
var tpl = new hydr.Template("My name is <strong>::name::</strong> and I'm <em>::age::</em> years old.");
...
// globals
hydr.Template.globals = { name : "John", age : 33 };
var output2 = tpl.execute( { } );
...
var t1 = new hydr.Template("Call macro : $$myfun(Hello,::param::)");
