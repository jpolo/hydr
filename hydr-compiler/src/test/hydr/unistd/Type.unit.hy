...
//Type.getClass(hydr.macro.Expr.ExprDef.EBreak) == null;
Type.getClass( { } ) == null;

// getEnum
Type.getEnum(hydr.macro.Expr.ExprDef.EBreak) == hydr.macro.Expr.ExprDef;
...
Type.getEnumName(hydr.macro.Expr.ExprDef) == "hydr.macro.ExprDef";
...
Type.resolveEnum("hydr.macro.ExprDef") == hydr.macro.Expr.ExprDef;
...
Type.allEnums(hydr.macro.Expr.ExprDef) == [EBreak, EContinue];
